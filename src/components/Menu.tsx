    ...
    return (
        <div ref={containerRef}>
            ...
            <div className="fixed inset-0">
                <div className="z-10 flex items-center justify-between p-8 bg-white text-black">
                ...
                <div className="flex flex-4 flex-col justify-between pt-32">
                    ...
                    <div className="flex gap-12">
                        ...
                        <div className="flex flex-col justify-end uppercase text-sm font-medium">
                            <p>contact@naaraentertainment.in</p>
                            <p>2342 232 343</p>
                        </div>
                    </div>
                </div>
